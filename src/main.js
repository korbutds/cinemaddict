...
import {createCardsNoControlsTemplate} from './templates/cards.js';
...
filmsTopRatedElement.innerHTML = createCardsNoControlsTemplate(createCardsMockData(AmountLimit.MIN));
filmsMostCommentedElement.innerHTML = createCardsNoControlsTemplate(createCardsMockData(AmountLimit.MIN));
