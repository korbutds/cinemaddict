...
export const createAmountTemplate = (amount) => (
...
export const createDurationTemplate = (duration) => (
  `${moment.duration(duration).days() ?
    moment.duration(duration).days() : ``}
    ${moment.duration(duration).days() ? `<span class="statistic__item-description">d</span>` : ``}
  ...
  `<section class="statistic">
    ...
    <ul class="statistic__text-list">
      ...
      <li class="statistic__text-item">
        ...
        <p class="statistic__item-text genre">Sci-Fi</p>
      </li>
    </ul>
